...
export const dropdownItems = {
  ...
  [
    ...
    {
      id: 3,
      title: "Goals and Core Values",
      path: "/about/goals"
    },
    {
      id: 4,
      title: "Institutional Directions",
      path: "/about/institutional"
    },
    {
      id: 5,
...
export const coreValues = [
  {
    id: 1,
    title: 'Faith',
    text: ['Spiritually and Emotionally Mature', 'Passionate commitment to truth', 'Respect for the dignity of the person'],
    values: ['Piety', 'Courage', 'Fidelity', 'Communion', 'Trust', 'Knowledge of the Catholic Faith']
  },
  {
    id: 2,
    title: 'Hope',
    text: ['Excellence', 'Professional Dignity and Attitude', 'Christian Leadership'],
    values: ['Competence', 'Resourcefulness', 'Self-reliance', 'Perseverance', 'Maturity', 'Accountability']
  },
  {
    id: 3,
    title: 'Charity',
    text: ['Social involvement', 'Simplicity of lifestyle', 'Humble - loving service'],
    values: ['Stewardship', 'Preferential Love for the Poor', 'Nationalism', 'Integrity', 'Discipline', 'Humility', 'Justice', 'Prudence']
  }
]
...
export const paascu = [
  {
    id: 1,
    title: "About PAASCU",
    text: ["PAASCU stands for Philippine Accrediting Association of Schools, Colleges, and Universities. It is a private, voluntary, non-profit and non- stock corporation which was registered with the Securities and Exchange Commission on November 5, 1957.",
  ...
  },
  {
    ...
    text: ["The Association does not impose arbitrary standards. The survey forms developed by PAASCU identify principles and practices which are found in excellent institutions. The statements in the survey forms are more qualitative rather than quantitative. The Association does not have specific formulas to apply or particular patterns of organization to follow. The criteria and survey instruments are merely tools to help the school measure educational quality. They are intended to serve as a guide for institutions as they strive for excellence and for accreditors as they assess institutional achievement.  The standards reflect a realistic appraisal of the school's resources and their efficient utilization to help the institution achieve its goals."]
  },
  {
    id: 3,
    title: "Benefits and Incentives",
    text: ["Full administrative deregulation, provided that reports of promotion of students and lists of graduates are available for review by CHED at all times.",
  ...
  },
  {
    ...
    text: ["Gives the institution and its faculty a sense of direction based on a clearer self-image.",
